...
users, several jurisdictions require disclosure or labeling of
AI-generated content (e.g. China's deep-synthesis rules and the EU
AI Act). These demos do **not** add such labels — consult applicable
laws and platform policies in your jurisdiction, and add the labels
your deployment requires before any AI output reaches a third-party
platform or end user.

Do not use these demos for abusive, deceptive, policy-violating, or
